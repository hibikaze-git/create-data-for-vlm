...
#SBATCH --output=sbatch_logs/4_least_dim_range=2048-4096.out
...
python synthesis_data.py ./commoncatalog-cc-by-sa-download/4/least_dim_range=2048-4096 ./images/4/least_dim_range=2048-4096 ./jsonl/4/least_dim_range=2048-4096
