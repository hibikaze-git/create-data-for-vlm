...
#SBATCH --output=sbatch_logs/least_dim_range=1024-2048.out
...
python synthesis_data.py ./commoncatalog-cc-by-sa-download/0/least_dim_range=1024-2048 ./images/0/least_dim_range=1024-2048 ./jsonl/0/least_dim_range=1024-2048 --num_processes 3
