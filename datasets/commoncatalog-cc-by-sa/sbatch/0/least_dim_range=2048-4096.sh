...
#echo "bash tools/update_0618cc_gpu_num.sh slurm0-a3-ghpc-11 stop 1" | at 1:00 22.06.2024

cd /storage4/work/yamaguchi/create-data-for-vlm/datasets/commoncatalog-cc-by-sa

python synthesis_data.py ./commoncatalog-cc-by-sa-download/0/least_dim_range=2048-4096 ./images/0/least_dim_range=2048-4096 ./jsonl/0/least_dim_range=2048-4096
