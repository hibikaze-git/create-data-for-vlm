...
#SBATCH --output=sbatch_logs/2_least_dim_range=512-768.out
#SBATCH --gpus-per-node=1
#SBATCH --cpus-per-task=24
#SBATCH --mem=100GB
#SBATCH --begin=2024-06-22T06:00:05
...
python synthesis_data.py ./commoncatalog-cc-by-sa-download/2/least_dim_range=512-768 ./images/2/least_dim_range=512-768 ./jsonl/2/least_dim_range=512-768
