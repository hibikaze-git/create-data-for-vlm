...
#SBATCH --output=sbatch_logs/2_least_dim_range=1024-2048.out
...
#echo "bash tools/update_0618cc_gpu_num.sh slurm0-a3-ghpc-3 stop 1" | at 1:10 22.06.2024

cd /storage4/work/yamaguchi/create-data-for-vlm/datasets/commoncatalog-cc-by-sa

python synthesis_data.py ./commoncatalog-cc-by-sa-download/2/least_dim_range=1024-2048 ./images/2/least_dim_range=1024-2048 ./jsonl/2/least_dim_range=1024-2048
