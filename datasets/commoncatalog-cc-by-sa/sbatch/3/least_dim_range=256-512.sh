...
#SBATCH --output=sbatch_logs/3_least_dim_range=256-512.out
...
python synthesis_data.py ./commoncatalog-cc-by-sa-download/3/least_dim_range=256-512 ./images/3/least_dim_range=256-512 ./jsonl/3/least_dim_range=256-512
