...
#SBATCH --output=sbatch_logs/3_least_dim_range=2048-4096.out
#SBATCH --gpus-per-node=1
#SBATCH --cpus-per-task=24
#SBATCH --mem=100GB
#SBATCH --begin=2024-06-22T15:20:06
...
python synthesis_data.py ./commoncatalog-cc-by-sa-download/3/least_dim_range=2048-4096 ./images/3/least_dim_range=2048-4096 ./jsonl/3/least_dim_range=2048-4096
